      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Grupo</span>
          </RouterLink>
        </li>
        <li>
          <RouterLink
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Sucursal</span>
          </RouterLink>
        </li>
        <li>
          <RouterLink
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Equipo</span>
          </RouterLink>
        </li>
      </ul>
    </div>
